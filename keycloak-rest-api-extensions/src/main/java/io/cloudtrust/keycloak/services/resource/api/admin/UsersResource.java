...
public class UsersResource extends org.keycloak.services.resources.admin.UsersResource {
    ...
    public Response createUser(final UserRepresentation rep) {
        ...
        if (kcSession.users().getUserByUsername(realm, rep.getUsername()) != null) {
            return ErrorResponse.exists("User exists with same username");
        }
        if (rep.getEmail() != null && !realm.isDuplicateEmailsAllowed() && kcSession.users().getUserByEmail(realm, rep.getEmail()) != null) {
        ...
        try {
            ...
            org.keycloak.services.resources.admin.UserResource.updateUserFromRep(profile, user, rep, kcSession, false);
