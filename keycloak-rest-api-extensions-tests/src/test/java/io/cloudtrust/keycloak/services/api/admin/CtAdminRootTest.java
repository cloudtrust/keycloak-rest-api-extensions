...
class CtAdminRootTest extends AbstractRestApiExtensionTest {
    ...
    void testNoUserDeclinedTOU() throws IOException, URISyntaxException {
        ...
        var users = api(keycloak, testRealm).query(deletableUserListType, "GET", "/realms/master/api/admin/expired-tou-acceptance", params);
    ...
    void testGetSupportInformation() throws IOException, URISyntaxException {
        ...
        var emailInfo = api(keycloak, testRealm).query(emailInfoListType, "GET", "/realms/master/api/admin/support-infos", params);
